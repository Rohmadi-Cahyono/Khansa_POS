...
public class Utility_ButtonFlat extends JButton {

    private Color MouseHover = new Color(113,202,112);
    private Color MousePress = new Color(164,253,163);
    private Color WarnaBackground = new Color(87,176,86);
