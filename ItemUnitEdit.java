...
public class ItemUnitEdit extends javax.swing.JInternalFrame {
    ...
    private void TampilEdit(){
        ...
        try {           
            ...
            java.sql.ResultSet rs = st.executeQuery("SELECT * FROM iunits WHERE unit_id =' "+Id+" ' ");
                if(rs.next()){                    
                    txtSatuan.setText(rs.getString("unit_name"));
                }
    ...
    private void Update(){             
        if (txtSatuan.getText() == null || txtSatuan.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Data Satuan Barang Tidak Boleh Kosong!!", "Khansa POS", JOptionPane.WARNING_MESSAGE);
                ...
                try{   
                        Id = ItemUnit.Id;                        
                        String sql ="UPDATE iunits SET unit_name='"+txtSatuan.getText()+"'  WHERE unit_id='"+Id+"' ";                      
   ...
   private void PopUpKategori(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtSatuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 270, -1));
